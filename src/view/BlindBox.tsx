      ...
      <div className="Edition-Center">
        ...
        <div className="BlindBoxInfo">
          <div className="Info">
            ...
            {
              BoxBase.map((item,index)=><div key={item.id} className="Row">
                  ...
                  item.status === 1 ?<>
                    {
                      ...
                      <div className="BuyBtn linear-gradient pointer" onClick={()=>{buyBox(index)}}>{t('BuyBtn')}</div>
                      </>:<>
                        {
                          ...
                          <div className="BuyBtn linear-gradient pointer" onClick={approveFun}>{t('Approve')}</div>
                          </>
                        }
                      </>
                    }
                  </>:<>
                    <div className="BuyBtn invalid pointer">{t('Not opened yet')}</div>
                  </>
                }
              </div>
              {
